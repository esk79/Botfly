...
def main():
    ...
    if USE_SSL_FLASK:
        socketio.run(app, debug=True, use_reloader=False, certfile=CERT_FILE, keyfile=KEY_FILE, port=5500, host='0.0.0.0')
    else:
        socketio.run(app, debug=True, use_reloader=False, port=5500, host='0.0.0.0')
